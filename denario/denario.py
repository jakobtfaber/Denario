"""
    ...
    Classes/Functions:
        - Denario (line 58):
            - _setup_input_files() -> None (line 106)
            ...
            - get_idea_fast(llm: LLM | str = models['gemini-2.0-flash'], verbose=False) -> None (line 195)
            - set_idea(idea: str = None) -> None (line 243)
            - show_idea() -> None (line 259)
            - check_idea() -> str (line 265)
            - check_idea_fast(llm: LLM | str = models['gemini-2.5-flash'], max_iterations: int = 7, verbose=False) -> None (line 297)
            ...
            - get_method_fast(llm: LLM | str = models['gemini-2.0-flash'], verbose=False) -> None (line 394)
            ...
            - set_results(results: str = None) -> None (line 537)
            - set_plots(plots: list[str] | list[Image.Image]) -> None (line 547)
            - show_results() -> None (line 561)
            - get_keywords(input_text: str, n_keywords: int = 5) -> None (line 567)
            - show_keywords() -> None (line 582)
            - get_paper(journal: Journal = Journal.NONE, llm: LLM | str = models['gemini-2.5-flash'], writer: str = 'scientist', cmbagent_keywords: bool = False, add_citations=True) -> None (line 591)
            - referee_fast(llm: LLM | str = models['gemini-2.5-flash'], verbose=False) -> None (line 657)
...
class Denario:
    ...
    def get_results(self,
                    ...
                    engineer_model: LLM | str = models["gemini-3-pro-preview"],
    ...
    def get_paper(self,
                  ...
                  llm: LLM | str = models["gemini-3-pro-preview"],
