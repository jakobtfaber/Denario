"""
    ...
    Classes/Functions:
        - idea_maker_prompt(state) (line 18)
        - idea_hater_prompt(state) (line 43)
        - methods_fast_prompt(state) (line 65)
        - novelty_prompt(state) (line 97)
        - novelty_reflection(round, reason, decision, previous_reasons) (line 146)
        - summary_literature_prompt(state) (line 167)
        - reviewer_fast_prompt(state) (line 190)
...
def novelty_prompt(state):
    ...
    return [HumanMessage(
        content=f"""You are an expert scientific research assistant. Your task is to evaluate whether a proposed idea is novel by comparing it against existing literature. Novelty is defined strictly as:
