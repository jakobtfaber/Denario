"""
    ...
    Classes/Functions:
        - idea_prompt(topic) (line 31)
        - reflection_prompt(topic, ideas) (line 50)
        - abstract_prompt(state, attempt) (line 88)
        - abstract_reflection(state) (line 122)
        - introduction_prompt(state) (line 155)
        - introduction_reflection(state) (line 192)
        - methods_prompt(state) (line 233)
        - results_prompt(state) (line 270)
        - refine_results_prompt(state) (line 314)
        - conclusions_prompt(state) (line 343)
        - caption_prompt(state, image, name=None) (line 385)
        - plot_prompt(state, images) (line 415)
        - LaTeX_prompt(text) (line 435)
        - clean_section_prompt(state, text) (line 469)
        - summary_prompt(state, text) (line 507)
        - references_prompt(state, text) (line 528)
        - fixer_prompt(text, section_name) (line 562)
        - fix_latex_bug_prompt(state) (line 589)
        - cmbagent_keywords_prompt(state) (line 620)
        - keyword_prompt(state) (line 629)
...
- For any mathematical derivations, equations, or symbolic computations, use the wolfram_compute tool to get exact solutions and LaTeX formatting.
- Include unit conversions, physical constants, and dimensional analysis where relevant.
- When deriving equations, show the Wolfram Alpha results with proper LaTeX formatting.
- Include exact mathematical forms and numerical values with proper scientific notation.
