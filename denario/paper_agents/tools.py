"""
    ...
    Classes/Functions:
        - LLM_call(prompt, state) (line 29)
        - LLM_call_stream(prompt, state) (line 49)
        - temp_file(state, fin, action, text=None, json_file=False) (line 89)
        - json_parser(text) (line 141)
        - json_parser2(text: str) (line 162)
        - json_parser3(text: str) (line 182)
        - extract_latex_block(state: GraphState, text: str, block: str) -> str (line 201)
        - fixer(state: GraphState, section_name) (line 233)
        - LaTeX_checker(state, text) (line 259)
        - clean_section(text, section) (line 268)
        - check_images_in_text(state, images) (line 292)
...
def json_parser2(text: str):
    ...
    try:
        ...
        raise ValueError(
            f"JSON parse error at pos {e.pos}: {e.msg}\n…{snippet}…")
...
def LLM_call_with_tools(prompt, state, llm_with_tools):
    """
