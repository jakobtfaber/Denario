"""
    ...
    Classes/Functions:
        - extract_latex_errors(state) (line 44)
        - clean_files(doc_name, doc_folder) (line 96)
        - compile_tex_document(state: dict, doc_name: str, doc_folder: str) -> None (line 105)
        - compile_latex(state: GraphState, paper_name: str) -> None (line 157)
        - save_paper(state: GraphState, paper_name: str) (line 222)
        - save_bib(state: GraphState) (line 285)
        - escape_special_chars(text) (line 291)
        - process_bib_file(input_file, output_file) (line 309)
        - fix_latex(state, f_temp) (line 334)
        - fix_percent(text) (line 367)
