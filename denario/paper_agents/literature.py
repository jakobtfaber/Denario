"""
    ...
    Classes/Functions:
        - _execute_query(payload, keys: KeyManager) (line 21)
        - perplexity(para, keys: KeyManager) (line 38)
        - process_tex_file_with_references(text, keys: KeyManager, nparagraphs=None) (line 97)
        - _extract_paragraphs_from_tex_content(tex_content: str) -> dict (line 162)
        - _arxiv_url_to_bib(citations: List[str]) -> Tuple[List[str], List[str]] (line 200)
        - _replace_grouped_citations(content: str, bib_keys: List[str]) -> str (line 258)
        - _replace_references_with_cite(content: str, citations: List[str], bibtex_file_str: str) -> Tuple[str, str] (line 294)
